  ...
  return (
    <Menus shadow="md" width={200}>
      ...
      <Menu.Dropdown>
        ...
        <Menu.Item icon={<IconUser size={14} /> } onClick={()=>{navigate(`/profile/${user._id}`)}}>Profile</Menu.Item>
        <Menu.Item icon={<IconUserEdit size={14} /> } onClick={()=>{navigate("/editprofile")}}>Edit Profile</Menu.Item>
        <Menu.Item icon={<IconMessageCircle size={14} />}>Messages</Menu.Item>
        <Menu.Item icon={<IconLogout2 size={14} /> } onClick={signOff}>Logout</Menu.Item>
